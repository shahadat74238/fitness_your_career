    ...
    <div className="w-full mb-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div  className=" grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-5 md:px-10">
          <div data-aos="fade-up-right" className=" py-10 text-center hover:shadow-md space-y-3 bg-[#f5f5f5]">
          ...
          <div data-aos="fade-up" className=" py-10 text-center hover:shadow-md space-y-3 bg-[#f5f5f5]">
          ...
          <div data-aos="fade-up-left" className=" py-10 text-center hover:shadow-md space-y-3 bg-[#f5f5f5]">
